...
function BenefitCard({ benefit, stars }: BenefitCardProps) {
  ...
  return (
    <div
      ...
      className="group relative flex flex-col h-full bg-slate-800/40 backdrop-blur-sm rounded-xl border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/10 hover:-translate-y-0.5 overflow-hidden cursor-pointer"
    >
